...
lab2_proc_srcs = \
  ...
  lab2-proc-PipelinedProcSimpleDpath.v \
  lab2-proc-PipelinedProcSimpleCtrl.v \
  lab2-proc-PipelinedProcSimple.v \
...
lab2_proc_gen_simple_test_srcs = \
  lab2-proc-PipelinedProcSimple-mngr.t.v \
  lab2-proc-PipelinedProcSimple-addiu.t.v \
  lab2-proc-PipelinedProcSimple-addu.t.v \
  lab2-proc-PipelinedProcSimple-lw.t.v \
  lab2-proc-PipelinedProcSimple-bne.t.v \
  lab2-proc-PipelinedProcSimple-j.t.v \
...
lab2-proc-eval : $(lab2_proc_eval_outs)
	@echo ""
	@echo "Verify:"
...
lab2-proc-harness :
    ...
    ece4750-lab2-proc \
    $(src_dir) \
    $(src_dir)/lab2-proc/lab2-proc-gen-harness-cfg
	cd ece4750-lab2-proc/lab2-proc/; \
	for i in `ls lab2-proc-PipelinedProcSimple*`;  \
		do echo renaming $$i; \
		cat $$i | \
			sed "s/Simple/Base/g" | \
			sed "s/SIMPLE/BASE/g" > \
	...
	rm lab2-proc-PipelinedProcSimple*; \
	cd ../..; \
	tar czvf ece4750-lab2-proc.tar.gz ece4750-lab2-proc \

.PHONY: lab2-proc-harness

lab2_proc_junk += ece4750-lab2-proc ece4750-lab2-proc.tar.gz
